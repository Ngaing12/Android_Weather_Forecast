...
public class CountryCodes {
    ...
    public String getCountryName(String countryCode){
        int index = _countryCodes.indexOf(countryCode);
        return _countryNames.get(index);
    }

    public String getCountryCode(String country){
        int index = _countryNames.indexOf(country);
        try{
            String countryCode = _countryCodes.get(index);
            return countryCode;
        }
    ...
    List<String> _countryCodes = Arrays.asList(
    ...
    List<String> _countryNames = Arrays.asList(
